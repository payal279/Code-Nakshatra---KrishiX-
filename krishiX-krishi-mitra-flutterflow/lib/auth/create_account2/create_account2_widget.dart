                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '7uhbbg6k' /* Let's get started by filling o... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'CREATE_ACCOUNT2_CREATE_ACCOUNT_BTN_ON_TA');
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'CREATE_ACCOUNT2_CONTINUE_WITH_GOOGLE_BTN');
                                        logFirebaseEvent(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CREATE_ACCOUNT2_RichText_5ygd42jo_ON_TAP');
                                          logFirebaseEvent(
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'mbz8atdc' /* Already have an account?  */,
                                                ),
                                                style: TextStyle(),
                                              ),
                                              TextSpan(
                                        ...
                                        children: [
                                          Expanded(
                                            child: AutoSizeText(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'gjze4txz' /* Nice outdoor courts, solid con... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
