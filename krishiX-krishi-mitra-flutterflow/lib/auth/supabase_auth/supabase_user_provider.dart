...
class KrishiSakhi2SupabaseUser extends BaseAuthUser {
  KrishiSakhi2SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> krishiSakhi2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = KrishiSakhi2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
