        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'SELECT_LANGUAGE_COMP_Row_ve1tzhwo_ON_TAP');
            ...
            Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'SELECT_LANGUAGE_COMP_Row_utnzoumy_ON_TAP');
                    logFirebaseEvent('Row_set_app_language');
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('SELECT_LANGUAGE_Container_mmtsay24_ON_TA');
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('SELECT_LANGUAGE_Container_5us3vpku_ON_TA');
                logFirebaseEvent('Container_set_app_language');
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('SELECT_LANGUAGE_Container_hs9r6vss_ON_TA');
                logFirebaseEvent('Container_set_app_language');
            ...
            InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('SELECT_LANGUAGE_Container_ac118xpr_ON_TA');
                logFirebaseEvent('Container_set_app_language');
                setAppLanguage(context, 'en');
              },
              child: Container(
